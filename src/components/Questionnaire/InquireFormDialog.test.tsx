...
import ReviewDialog from "./InquireFormDialog";
...
describe("Basic Functionality", () => {
  ...
  it("should disable all actions when `disableActions` is true", () => {
    ...
    expect(getByRole("button", { name: /Confirm to move to Inquired/i })).toBeDisabled();
  });
  ...
  it("should call the `onSubmit` function when the confirm button is clicked", () => {
    ...
    userEvent.click(getByRole("button", { name: /Confirm to move to Inquired/i }));
...
describe("Implementation Requirements", () => {
  it("disables the confirm button when no review comment is entered", () => {
    ...
    expect(getByRole("button", { name: /Confirm to move to Inquired/i })).not.toBeDisabled();
  });
